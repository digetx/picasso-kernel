...
#if defined(CONFIG_PM_EARLYSUSPEND) && defined(DHD_USE_EARLYSUSPEND)
#include <linux/earlysuspend.h>
#endif /* defined(CONFIG_PM_EARLYSUSPEND) && defined(DHD_USE_EARLYSUSPEND) */
...
#endif /* CONFIG_PM_EARLYSUSPEND  && defined(DHD_USE_EARLYSUSPEND) */
...
#endif /* defined(CONFIG_PM_EARLYSUSPEND) */
