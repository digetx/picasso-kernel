...
static void tegra_camera_capture_setup(struct tegra_camera_dev *pcdev)
{
	...
	case V4L2_MBUS_FMT_UYVY8_2X8:
		pr_info("input_code V4L2_MBUS_FMT_UYVY8_2X8\n");
		yuv_input_format = 0x2;
		break;
	case V4L2_MBUS_FMT_VYUY8_2X8:
		pr_info("input_code V4L2_MBUS_FMT_VYUY8_2X8\n");
		yuv_input_format = 0x3;
		break;
	case V4L2_MBUS_FMT_YUYV8_2X8:
		pr_info("input_code V4L2_MBUS_FMT_YUYV8_2X8\n");
		yuv_input_format = 0x0;
		break;
	case V4L2_MBUS_FMT_YVYU8_2X8:
		pr_info("input_code V4L2_MBUS_FMT_YVYU8_2X8\n");
