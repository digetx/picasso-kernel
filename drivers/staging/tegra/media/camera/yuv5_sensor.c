...
extern int extern_tegra_camera_enable_vi(void);
extern int extern_tegra_camera_disable_vi(void);
...
static struct of_device_id yuv5_sensor_of_match[] = {
	{ .compatible = "aptina,mt9p111", },
	{ },
};
MODULE_DEVICE_TABLE(of, yuv5_sensor_of_match);

static struct i2c_driver yuv5_sensor_i2c_driver = {
	.driver = {
		.name = SENSOR_5M_NAME,
		.owner = THIS_MODULE,
		.of_match_table = of_match_ptr(yuv5_sensor_of_match),
	},
	.probe = sensor_probe,
	.remove = sensor_remove,
	.id_table = sensor_id,
};
module_i2c_driver(yuv5_sensor_i2c_driver);
